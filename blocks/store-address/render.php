 ...
 */
function dokan_render_store_address_block( array $attributes, string $content, WP_Block $block ): string {
	...
	if ( empty( $vendor ) || empty( $vendor['id'] ) ) {
		return '<p class="dokan-store-address">123 Main St, City, Country</p>';
	}
