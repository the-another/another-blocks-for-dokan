...
const TEMPLATE = [
	[ 'core/group', { 
		...
		[ 'the-another/dokan-store-avatar', { width: '8rem', height: '8rem' } ],
		[ 'core/group', {
			style: { spacing: { margin: { left: '2rem' } } },
			layout: { type: 'flex', orientation: 'vertical' },
		}, [
			[ 'the-another/dokan-store-name', { tagName: 'h1' } ],
			[ 'the-another/dokan-store-rating' ],
			[ 'the-another/dokan-store-hours', { layout: 'compact', showCurrentStatus: true } ],
		] ],
	] ],
];
