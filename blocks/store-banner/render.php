 ...
 */
function dokan_render_store_banner_block( array $attributes, string $content, WP_Block $block ): string {
	...
	if ( empty( $vendor ) || empty( $vendor['id'] ) ) {
		...
		$wrapper_attributes = get_block_wrapper_attributes(
			array(
				'class' => 'dokan-store-banner dokan-store-banner--no-vendor',
