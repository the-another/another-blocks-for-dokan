 ...
 */
function dokan_render_store_terms_conditions_block( array $attributes, string $content, WP_Block $block ): string {
	...
	$wrapper_attributes = get_block_wrapper_attributes(
		array(
			'class' => 'dokan-store-terms-conditions',
		)
	);
	...
	<div <?php echo $wrapper_attributes; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
		<div id="store-toc-wrapper">
			<div id="store-toc">
				<?php if ( $show_title ) : ?>
					<<?php echo esc_attr( $title_tag ); ?> class="dokan-store-toc-title headline">
						<?php esc_html_e( 'Terms and Conditions', 'another-dokan-blocks' ); ?>
					</<?php echo esc_attr( $title_tag ); ?>>
				<?php endif; ?>
				<div class="dokan-store-toc-content">
