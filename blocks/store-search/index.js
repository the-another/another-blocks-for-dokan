...
function Edit( { attributes, setAttributes } ) {
	...
	return (
		<>
			...
			<div { ...blockProps }>
				<div className="dokan-store-listing-filter-wrap">
							...
							{ enableSearch && (
								<div className="dokan-store-filter-right-item">
									<div className="item">
										...
										<button
											type="button"
											className={ 'dokan-store-list-filter-button ' + buttonClasses.join( ' ' ) }
				...
				{ enableSearch && (
					<form
						...
						className="dokan-store-search-filter-form"
						style={ { display: 'block' } }
					>
						<div className="dokan-store-search-filter-row">
							<div className="store-search grid-item">
								<input
									type="search"
									className="store-search-input dokan-store-search-input"
