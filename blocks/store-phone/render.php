 ...
 */
function dokan_render_store_phone_block( array $attributes, string $content, WP_Block $block ): string {
	...
	if ( empty( $vendor ) || empty( $vendor['id'] ) ) {
		return '<p class="dokan-store-phone">+1 234 567 8900</p>';
	}
