/**
 * Store Logo block editor component.
 *
 * @package DokanBlocks
 * @since 1.0.0
 */
...
/**
 * Store Logo block edit component.
 *
...
function Edit( { attributes, setAttributes, context } ) {
	...
	const blockProps = useBlockProps( {
		className: `dokan-store-avatar${ align ? ` has-text-align-${ align }` : '' }`,
		style: wrapperStyle,
	} );
	...
	const imageElement = (
		<img
			...
			alt={ storeName }
			style={ imageStyle }
			className="dokan-store-avatar-image"
		/>
	);
...
/**
 * Store Logo block save component.
 *
